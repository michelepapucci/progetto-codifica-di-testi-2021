    ...
    <xsl:template match="tei:body/tei:div[2]/tei:div[@type='destination']">
        ...
        <xsl:if test="count(following-sibling::tei:fw)>0">
            <div class = "note_segni_div">
                <a class = "bold">Note e altre segni: </a><br/>
            ...
            <span>
                <xsl:choose>
                    <xsl:when test="count(//tei:zone[@xml:id = $final_id_stamp]/@ulx)>0">
                        <xsl:attribute name="data-ulx"><xsl:value-of select="//tei:zone[@xml:id = $final_id_stamp]/@ulx"/></xsl:attribute>
                        <xsl:attribute name="data-uly"><xsl:value-of select="//tei:zone[@xml:id = $final_id_stamp]/@uly"/></xsl:attribute>
                        <xsl:attribute name="data-lrx"><xsl:value-of select="//tei:zone[@xml:id = $final_id_stamp]/@lrx"/></xsl:attribute>
                        <xsl:attribute name="data-lry"><xsl:value-of select="//tei:zone[@xml:id = $final_id_stamp]/@lry"/></xsl:attribute>
                    </xsl:when>
                    <xsl:otherwise>
                        <xsl:attribute name="data-points"><xsl:value-of select="//tei:zone[@xml:id = $final_id_stamp]/@points"/></xsl:attribute>
                    </xsl:otherwise>
                </xsl:choose>
            </span>
        </a>
